$(document).ready(function () {
    ...
    function getCentersList(id) {
        $.ajax({
            type: "GET",
            url: "http://68.183.90.145:3061/getLocationData/" + id,
            dataType: 'json',
            success: (response) => {
